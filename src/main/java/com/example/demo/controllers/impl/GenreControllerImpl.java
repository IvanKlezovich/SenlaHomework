...
//        List<GenreDto> genre = genreService.getAllGenre();
//        return (genre.isEmpty()) ? ResponseEntity.noContent().build() : ResponseEntity.ok(objectMapper.writeValueAsString(genre));
//    }
//
//    /**
//     * Creates a new genre.
...
//     */
//    @Override
//    public ResponseEntity<HttpStatus> updateGenre(UpdateDto<GenreDto> genreDtoUpdateDto) {

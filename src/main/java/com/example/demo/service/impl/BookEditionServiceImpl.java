...
public class BookEditionServiceImpl implements BookEditionService {
     ...
     */
    public ResponceDto delete(BookEditionDto bookEditionDto) {
     ...
     * @return a {@link ResponceDto} indicating the result of the operation.
     */
    public ResponceDto save(BookEditionDto bookEditionDto) {
     ...
     * @return a {@link ResponceDto} indicating the result of the operation.
     */
    public ResponceDto update(UpdateDto<BookEditionDto> bookEditionDtoUpdateDto) {

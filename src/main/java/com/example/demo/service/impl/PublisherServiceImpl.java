...
public class PublisherServiceImpl implements PublisherService {
     ...
     */
    public ResponceDto delete(PublisherDto publisherDto) {
     ...
     * @return a {@link ResponceDto} indicating the result of the operation.
     */
    public ResponceDto save(PublisherDto publisherDto) {
     ...
     * @return a {@link ResponceDto} indicating the result of the operation.
     */
    public ResponceDto update(UpdateDto<PublisherDto> publisherUpdateDto) {
